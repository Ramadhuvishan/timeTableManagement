...
<div align="center" STYLE="margin-top: 80px">
    <button id="teacherLoginBtn" class="btn btn-info btn-lg">TEACHER LOGIN
    </button>
    <button id="adminLoginBtn" class="btn btn-success btn-lg">ADMIN LOGIN
    </button>
</div>
<br>
<div align="center">
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof. RAJIV</h3>
                    <hr/>
                    <h4 align="center">H.O.D<br/>F/o the Department</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. M. RAJASEKAR</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> VCET</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/chairman.jpg" class="img-rounded"/>
                    <h3 align="center">PROF. RAJU</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>  VET</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>MADURAI, TAMILNADU</h4>
                <h4>PINCODE - 625 009</h4>
                <h4><strong>Call:</strong> 2587946, 2654789 </h4>
                <h4><strong>Email: </strong>student19@vcet.ac.in</h4>
            </div>
        </div>
    </div>
</div>
